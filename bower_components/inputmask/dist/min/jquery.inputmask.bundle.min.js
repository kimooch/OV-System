...
!(function (a) {
            ...
            inputFallBackEvent: function (b) {
              ...
              if (z().join("") !== d) {
                ...
                if (h !== k) {
                  n.begin = 0;
                  for (
                    var r = (q = h.length >= k.length) ? h.length : k.length,
                      s = 0;
                    h.charAt(s) === k.charAt(s) && s < r;
                    s++
                  )
                    n.begin++;
                ...
                i !== m &&
                  (i.length > m.length
                    ? q && (n.end = n.begin)
                    : i.length < m.length
                      ? (n.end += m.length - i.length)
                      : i.charAt(0) !== m.charAt(0) && n.end++),
                  I(c, z(), n),
                  o.length > 0
                    ? a.each(o.split(""), function (b, d) {
                        var e = new a.Event("keypress");
                        (e.which = d.charCodeAt(0)),
                          (aa = !1),
                          da.keypressEvent.call(c, e);
                      })
                    : (n.begin === n.end - 1 && M(c, G(n.begin + 1), n.end),
            ...
            definitions: {
              1: {
                validator: function (a, b, c, d, e) {
                  if ("3" == a.charAt(0)) {
                    if (new RegExp("[2-9]").test(a.charAt(1)))
                      return (a = "30"), (b.buffer[c] = "0"), c++, { pos: c };
                  }
              ...
              2: {
                validator: function (a, b, c, d, e) {
                  ...
                  if (
                    ...
                    if (new RegExp("[3-9]").test(a.charAt(1)))
                      return (a = "10"), (b.buffer[c] = "0"), c++, { pos: c };
                  }
                      ...
                      if (!0 === g.isGroup) d = h(g, !0);
                        ...
                        if (isNaN(g.quantifier.max)) {
                          for (
                            ...
                            g.repeaterPart &&
                            g.repeaterPart !== l &&
                            g.repeaterPart.length > l.length &&
                            !(d = h(k, !0));

                          );
                          (d = d || h(k, !0)),
                            d && (g.repeaterPart = l),
                            (l = m + g.quantifier.max);
                        } else {
                          for (
                            var o = 0, p = g.quantifier.max - 1;
                            o < p && !(d = h(k, !0));
                            o++
                          );
                          l =
                        ...
                        for (var q = 0; q < g.length && !(d = h(g[q], c)); q++);
                      else {
                        var r;
                        if ("[" == g.charAt(0)) {
                          (r = l), (r += g);
                              ...
                              k =
                                1 === h.length
                                  ...
                                  : isNaN(h[1])
                                    ...
                                    : parseInt(h[1]);
                            if (
                              ((e.quantifier = { min: i, max: k }),
                              d.length > 0)
                            ) {
                              var l = d[d.length - 1].matches;
                              (a = l.pop()),
                                a.isGroup ||
                                  ((j = new g(!0)), j.matches.push(a), (a = j)),
                                l.push(a),
                                l.push(e);
                            } else
                              (a = c.matches.pop()),
  ...
  function (a, b, c) {
    ...
    var e = c(1),
      ...
      i = c(2),
      j = d(i);
    h.default === j.default && c(8), (window.Inputmask = f.default);
  },
  function (a, b, c) {
    "use strict";
    var d;
