      ...
      numeric: {
        ...
        postValidation: function (d, e, f) {
          ...
          k !== c &&
            ...
            i < f.prefix.length - 1 + (!1 === f.isNegative ? 1 : 0)
              ...
              : f.suffix.length > 0 &&
                i >=
                  j.length - f.suffix.length - (!1 === f.isNegative ? 1 : 0) &&
                (g[
                  i -
                    (j.length - f.suffix.length - (!1 === f.isNegative ? 1 : 0))
                ] = "?")),
          ...
          if (
            ...
            (l += g),
            f.isNegative &&
              ((l = f.negationSymbol.front + l), (l += f.negationSymbol.back)),
            (l = l.split("")),
            k !== c)
          )
            if (
              ...
              (i = a.inArray("?", l)), i > -1 ? (l[i] = k) : (i = e.caret || 0);
            else if (
              k === f.radixPoint ||
              k === f.negationSymbol.front ||
              k === f.negationSymbol.back
        ...
        regex: {
          integerPart: function (a, c) {
            return c
              ? new RegExp("[" + b.escapeRegex(a.negationSymbol.front) + "+]?")
              : new RegExp(
