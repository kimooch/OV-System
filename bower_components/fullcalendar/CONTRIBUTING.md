...
if (true) {
  ...
  // please put else, else if, and catch on a separate line
}
...
- **use _tabs_ instead of spaces**
- separate functions with _2_ blank lines
- separate logical blocks within functions with _1_ blank line
