  ...
  Grid.mixin({
    ...
    renderEventsPayload: function (eventsPayload) {
      ...
      for (id in eventsPayload) {
        ...
        eventRenderRanges = eventInstanceGroup.sliceRenderRanges(
...
*/
  Grid.mixin({
    ...
    handleSegMousedown: function (seg, ev) {
      ...
      if (
        !isResizing &&
        this.view.isEventDefDraggable(seg.footprint.eventDef)
      ) {
    ...
    renderHelperEventFootprints: function (eventFootprints, sourceSeg) {
      return this.renderHelperEventFootprintEls(
        eventFootprints,
        sourceSeg,
      ).addClass("fc-helper");
    },
        ...
        hitOver: function (hit, isOrig, origHit) {
          ...
          if (origFootprint && footprint) {
            ...
            if (eventDefMutation) {
              ...
              isAllowed = _this.isEventInstanceGroupAllowed(
                mutatedEventInstanceGroup,
              );
            } else {
              isAllowed = false;
  ...
  Grid.mixin({
            ...
            if (hitFootprint) {
              ...
              if (singleEventDef) {
                ...
                isAllowed = meta.eventProps // isEvent?
                  ...
                  : _this.isExternalInstanceGroupAllowed(
                      mutatedEventInstanceGroup,
                    );
              } else {
                isAllowed = false;
    ...
    isExternalInstanceGroupAllowed: function (eventInstanceGroup) {
      ...
      for (i = 0; i < eventFootprints.length; i++) {
        ...
        if (
          !calendar.isSelectionFootprintAllowed(
  ...
  var TimeGrid = (FC.TimeGrid = Grid.extend(DayTableMixin, {
    ...
    renderSlatRowHtml: function () {
      ...
      while (slotTime < view.maxTime) {
        slotDate = calendar
          .msToUtcMoment(this.unzonedRange.startMs)
          .time(slotTime);
        isLabeled = isInt(
    ...
    fgSegHtml: function (seg, disableResizing) {
      ...
      if (view.isMultiDayRange(componentFootprint.unzonedRange)) {
        ...
        if (seg.isStart || seg.isEnd) {
          ...
          fullTimeText = this._getEventTimeText(
            zonedStart,
            zonedEnd,
            isAllDay,
            "LT",
          );
          startTimeText = this._getEventTimeText(
            zonedStart,
            zonedEnd,
            isAllDay,
            null,
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var View = (FC.View = ChronoComponent.extend({
    ...
    renderSelectionFootprint: function (footprint, ev) {
      if (this.renderSelection) {
        ...
        ChronoComponent.prototype.renderSelectionFootprint.apply(
          this,
          arguments,
        );
      }
  ...
  View.mixin({
    ...
    currentRangeAs: function (unit) {
      ...
      return moment
        .utc(currentUnzonedRange.endMs)
        .diff(moment.utc(currentUnzonedRange.startMs), unit, true);
    },
...
*/
  Calendar.prototype.buildCurrentBusinessFootprints = function (wholeDay) {
    return this._buildCurrentBusinessFootprints(
      wholeDay,
      this.opt("businessHours"),
    );
  };

  Calendar.prototype._buildCurrentBusinessFootprints = function (
    wholeDay,
    businessDefInput,
  ) {
...
*/
  Calendar.prototype.buildBusinessInstanceGroup = function (
    wholeDay,
    rawComplexDef,
    unzonedRange,
  ) {
...
*/
  ...
  var SingleEventDef = EventDef.extend({
	...
	*/
    applyManualRawProps: function (rawProps) {
      var superSuccess = EventDef.prototype.applyManualRawProps.apply(
        this,
        arguments,
      );
  ...
  var RecurringEventDef = EventDef.extend({
	...
	*/
    applyRawProps: function (rawProps) {
      var superSuccess = EventDef.prototype.applyRawProps.apply(
        this,
        arguments,
      );
...
*/
  ...
  var ArrayEventSource = EventSource.extend({
	...
	*/
    ...
    applyManualRawProps: function (rawProps) {
      var superSuccess = EventSource.prototype.applyManualRawProps.apply(
        this,
        arguments,
      );
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var MonthView = (FC.MonthView = BasicView.extend({
    ...
    isDateInOtherMonth: function (date) {
      return (
        date.month() !== moment.utc(this.currentUnzonedRange.startMs).month()
      ); // TODO: optimize
    },
  }));
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var agendaTimeGridMethods = {
    ...
    renderHeadIntroHtml: function () {
      var view = this.view;
      var weekStart = view.calendar.msToUtcMoment(
        ...
        if (segRange) {
          ...
          if (
            ...
            footprint.unzonedRange.endMs <
              dayRanges[dayIndex + 1].startMs + view.nextDayThreshold
          ) {
