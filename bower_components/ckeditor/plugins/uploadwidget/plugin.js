...
(function () {
  CKEDITOR.plugins.add("uploadwidget", {
    lang: "az,ca,cs,da,de,de-ch,el,en,eo,es,es-mx,eu,fr,gl,hr,hu,id,it,ja,km,ko,ku,nb,nl,no,oc,pl,pt,pt-br,ru,sk,sv,tr,ug,uk,zh,zh-cn",
  ...
  CKEDITOR.tools.extend(CKEDITOR.fileTools, {
          ...
          function (f) {
            ...
            if (!f.dataValue && k)
              for (h = 0; h < k; h++)
                if (
                  ((d = n.getFile(h)),
                  !c.supportedTypes || g.isTypeSupported(d, c.supportedTypes))
                ) {
                  var l = c.fileToElement(d);
                  d = b.create(d);
                  l &&
                    (d[m](c.uploadUrl, c.additionalRequestParameters),
                    CKEDITOR.fileTools.markElement(l, e, d.id),
    ...
    markElement: function (a, e, c) {
      a.setAttributes({ "data-cke-upload-id": c, "data-widget": e });
    },
    bindNotifications: function (a, e) {
      ...
      e.on("update", function () {
        !b &&
          e.uploadTotal &&
          (c(), (b = g.createTask({ weight: e.uploadTotal })));
