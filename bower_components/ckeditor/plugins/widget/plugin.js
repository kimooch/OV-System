...
(function () {
  ...
  function L(a) {
    ...
    b.on("dragstart", function (d) {
      var c = d.data.target;
      g.isDomDragHandler(c) &&
        ((c = a.getByElement(c)),
        d.data.dataTransfer.setData("cke/widget-id", c.id),
        b.focus(),
        c.focus());
    });
        ...
        b.data.dataValue.forEach(
          function (b) {
            ...
            if ("data-cke-widget-id" in c) {
              ...
              return (
                (f[f.length - 1].editables[c["data-cke-widget-editable"]] = b),
                !1
              );
          },
  ...
  CKEDITOR.plugins.add("widget", {
    lang: "af,ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-gb,eo,es,es-mx,eu,fa,fi,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lv,nb,nl,no,oc,pl,pt,pt-br,ru,sk,sl,sq,sv,tr,tt,ug,uk,vi,zh,zh-cn",
        ...
        if (this.checkApplicable(f, a))
          for (var g = 0, k = this.group.length; g < k; g++) {
            ...
            for (var m = 0; m < b.length; m++)
              b[m] !== this &&
                b[m].checkActive(f, a) &&
                (a.widgets.focused.removeStyle(b[m]), (h = !0));
          }
        return h;
      },
