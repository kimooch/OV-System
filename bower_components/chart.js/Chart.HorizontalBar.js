    ...
    initialize: function (data) {
      ...
      this.ScaleClass = Chart.Scale.extend({
        ...
        calculateBaseHeight: function () {
          return (
            (this.endPoint - this.startPoint) / this.yLabels.length -
            2 * options.barValueSpacing
          );
        },
        calculateBarHeight: function (datasetCount) {
          ...
          var baseHeight =
            ...
            datasetCount * options.barDatasetSpacing;
        ...
        calculateXInvertXY: function (value) {
          var scalingFactor =
            (this.width -
              Math.round(this.xScalePaddingLeft) -
              this.xScalePaddingRight) /
            (this.max - this.min);
          return (
            Math.round(this.xScalePaddingLeft) +
            scalingFactor * (value - this.min)
          );
        },

        calculateYInvertXY: function (index) {
          return (
            index * ((this.startPoint - this.endPoint) / this.yLabels.length)
          );
        },
        ...
        calculateBarY: function (datasetCount, datasetIndex, barIndex) {
          ...
          var yHeight = this.calculateBaseHeight(),
            yAbsolute =
              this.endPoint +
              this.calculateYInvertXY(barIndex) -
              yHeight / 2 -
              5,
        ...
        buildCalculatedLabels: function () {
          ...
          for (var i = 0; i <= this.steps; i++) {
            this.calculatedLabels.push(
              helpers.template(this.templateString, {
        ...
        buildYLabels: function () {
          this.buildYLabelCounter =
            typeof this.buildYLabelCounter === "undefined"
              ? 0
              : this.buildYLabelCounter + 1;
          ...
          this.yLabelWidth =
            this.display && this.showLabels
              ? helpers.longestText(this.ctx, this.font, this.yLabels)
              : 0;
        },
        ...
        calculateX: function (index) {
          var isRotated = this.xLabelRotation > 0,
            ...
            valueWidth =
              innerWidth / (this.steps - (this.offsetGridLines ? 0 : 1)),
                  ...
                  .transition(
                    {
                      ...
                      height: this.scale.calculateBarHeight(
                        this.datasets.length,
                      ),
                    },
                    easingDecimal,
