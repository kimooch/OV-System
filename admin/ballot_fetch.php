...
while ($row = $query->fetch_assoc()) {
    ...
    $output .=
        ...
        '</b></h3>
							<div class="pull-right box-tools">
				                <button type="button" class="btn btn-default btn-sm moveup" data-id="' .
        $row["id"] .
        '" ' .
        $updisable .
        '><i class="fa fa-arrow-up"></i> </button>
				                <button type="button" class="btn btn-default btn-sm movedown" data-id="' .
        $row["id"] .
        '" ' .
        $downdisable .
    ...
    $sql =
        "UPDATE positions SET priority = '$num' WHERE id = '" .
        $row["id"] .
        "'";
    $conn->query($sql);
